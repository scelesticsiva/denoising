...
if __name__ == '__main__':
    ...
    train_Y = np.reshape(train_Y, (-1, train_Y.shape[2], train_Y.shape[3], train_Y.shape[4]))
    val_Y = np.reshape(val_Y, (-1, val_Y.shape[2], val_Y.shape[3], val_Y.shape[4]))
    ...
    model = CARE(config, 'care_planaria_2D', basedir='/storage/home/hcoda1/0/schaudhary9/p-hl94-0/siva_projects/baseline_denoising/care')
